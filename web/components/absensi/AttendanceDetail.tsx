      ...
      <div className="relative w-full max-w-lg bg-white h-screen shadow-2xl animate-in slide-in-from-right duration-300 flex flex-col">
        ...
        <div className="flex-1 overflow-y-auto p-6 space-y-8 text-left">
          ...
          <div className="flex items-center gap-4 p-4 bg-muted/30 rounded-xl">
            ...
            <div>
              <p className="font-bold text-lg">{record.employee_name}</p>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="p-4 border rounded-xl space-y-2">
              ...
              <p className="text-2xl font-bold text-foreground">{record.check_in || '--:--'}</p>
            ...
            <div className="p-4 border rounded-xl space-y-2">
              ...
              <p className="text-2xl font-bold text-foreground">{record.check_out || '--:--'}</p>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="space-y-2 text-center">
                <div className="aspect-[3/4] bg-muted rounded-xl overflow-hidden border-2 border-primary/20">
                  <img src={`https://api.dicebear.com/7.x/avataaars/svg?seed=${record.employee_name}_in`} className="w-full h-full object-cover" alt="Check-in photo" />
                </div>
                <p className="text-[10px] font-bold text-muted-foreground uppercase">Foto Masuk</p>
              </div>
              <div className="space-y-2 text-center">
                <div className="aspect-[3/4] bg-muted rounded-xl overflow-hidden border-2 border-primary/20">
                  <img src={`https://api.dicebear.com/7.x/avataaars/svg?seed=${record.employee_name}_out`} className="w-full h-full object-cover" alt="Check-out photo" />
                </div>
          ...
          <div className="space-y-4">
            ...
            <div className={cn(
              ...
              record.is_valid_location ? "bg-green-50 text-green-700" : "bg-red-50 text-red-700"
            )}>
              <AlertCircle className="w-4 h-4" />
              {record.is_valid_location ? 'Berada di dalam radius kantor (HQ Jakarta)' : 'Berada di luar radius kantor yang diizinkan'}
            </div>
          </div>
